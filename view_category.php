          ...
          <div class="page_title_block">
            ...
            <div class="col-md-7 col-xs-12">
              <div class="search_list">
                ...
                <?php if(isAdmin()) { ?><div class="add_btn_primary"> <a href="add_category.php?add=yes">Add Category</a> </div> <?php } ?>
              </div>
            </div>
          </div>
              ...
              <div class="col-lg-4 col-sm-6 col-xs-12">
                <div class="block_wallpaper add_wall_category">           
                  <div class="wall_image_title">
                    <h2><a href="#"><?php echo $row['category_name'];?> <span>(<?php echo get_total_songs($row['cid']);?>)</span></a></h2>
                    <ul>
                    <?php if(isAdmin()) { ?>                
                      ...
                      <?php } } else {?>
                        <li><a href="category.php?cat_id=<?php echo $row['cid'];?>" data-toggle="tooltip" data-tooltip="View Songs"><i class="fa fa-eye"></i></a></li>               
