      ...
      <div class="app-body">
        <div class="app-block">
          <div class="app-form login-form">
            ...
            <div class="text-center">
                <a href="login.php"><input type="submit" class="btn btn-success btn-submit" value="Login test"></a>
              </div>
              <div class="text-center">
                <a href="index2.php"><input type="submit" class="btn btn-success btn-submit" value="INDEX2"></a>
              </div>
          </div>
        </div>
      </div>
