...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 12, 2019 at 03:12 PM
...
(1, 'admin', 'admin', 'rinpasahil@gmail.com', 'profile.png');
...
INSERT INTO `tbl_album` (`aid`, `album_name`, `album_image`, `status`, `album_artist`) VALUES
(1, 'Hello', '48142_sweet.jpg', 1, '0'),
(2, 'testt', '42085_ukulele.jpg', 1, ''),
(3, 'Hello', '59830_sweet.jpg', 1, 'vedant ');
...
(1, 'vedant ', '25274_default_avatar.png'),
(3, 'Rocking Hills Studios', '5713_kinnaurigeet.png'),
(4, 'Rocking Hills Studiosdadadad', '98607_ukulele.jpg'),
(5, 'artist3', '30954_'),
(6, 'artist6', '61269_'),
(7, 'artist8', '42696_');
...
(2, 'Kinnauri Songs 2018', '83449_350.jpg', 1);
...
(1, 1, 1, 'server_url', 'Nalang Chu Bare   - LATESTKINNAURISONGS.COM', 'http://latestkinnaurisongs.com/files/Rocking Hills Studios/Seela Bosering [Latestkinnaurisong.com] .mp3', '55308_goinghigher.jpg', '3.25', 'Rocking Hills Studios,vedant ', '', 0, 0, 1, 0, 1),
(2, 2, 3, 'server_url', 'Seela Bosering By Ashish Negi', 'http://latestkinnaurisongs.com/files/Rocking%20Hills%20Studios/Seela%20Bosering%20[Latestkinnaurisong.com]%20.mp3', '41172_goinghigher.jpg', '3.25', 'Rocking Hills Studiosdadadad', '', 0, 0, 1, 0, 1);
...
INSERT INTO `tbl_playlist` (`pid`, `playlist_name`, `playlist_image`, `playlist_songs`, `status`, `uid`) VALUES
(1, 'Latest Kinnauri Songs', '24457_funkyelement.jpg', '1', 1, 1),
(2, 'Latest Kinnauri Songs', '24748_ukulele.jpg', '2,1', 1, 0);
...
INSERT INTO `tbl_users` (`id`, `username`, `firstName`, `lastName`, `email`, `password`, `signupDate`, `image`, `isAdmin`) VALUES
(1, 'rinpa', 'sahil', 'kumar', 'rinpas333@gmail.com', 'admin', '2019-02-08 00:00:00', 'profile.png', 0),
(2, 'test', 'test', 'test', 'test@123.com', 'test', '2019-02-09 00:00:00', '', 1);
