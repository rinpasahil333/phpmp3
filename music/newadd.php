...
<input type="text" name="title" id="name" value="<?php echo $_GET['title']; ?>" required="required" placeholder="Please Enter Name"/><br /><br />
...
<input type="text" name="source" value="<?php echo $_GET['source']; ?>" id="text" required="required" placeholder="Source Name"/><br/><br />
<label>Song Image :</label>
<input type="text" name="image" id="icon" value="<?php echo $_GET['icon']; ?>" placeholder="Image link"/><br/><br />
<label>Song Track Number :</label>
<input type="text" name="trackNumber" value="0" id="text" required="required" placeholder="trackNumber"/><br/><br />
...
<input type="text" name="duration" value="<?php echo $_GET['duration']; ?>" id="city" placeholder="Song Duration"/><br/><br />
